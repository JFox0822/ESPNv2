...
_proj_hits = [0, 0, 0]   # [espn_proj_found, prior_year_used, total]
...
def blended_stats(player, pw):
    ...
    Priority for the projected component:
      ...
      2. 2025 actual stats as baseline
      3. Current 2026 actuals only
    """
    actual    = get_stats(player, projected=False, debug=(_proj_hits[2]==0))
